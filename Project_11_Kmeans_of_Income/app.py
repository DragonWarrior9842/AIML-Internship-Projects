...
# =================================================================
# 👨‍💻 ABOUT THE DEVELOPER — Floating Hover Card (bottom-right)
# =================================================================
st.markdown(
    """
    <style>
    @import url('https://fonts.googleapis.com/css2?family=Space+Grotesk:wght@500;700&family=Fira+Code:wght@400;500&display=swap');
    ...
    #dev-toggle {
        ...
        font-size: 26px;
        color: white;
        box-shadow: 0 4px 18px rgba(37, 117, 252, 0.55);
        cursor: pointer;
    ...
    #dev-toggle:hover {
        ...
        box-shadow: 0 6px 24px rgba(37, 117, 252, 0.75);
    }
    ...
    <div id="dev-card">
        ...
        <div id="dev-toggle" title="About the Developer">👨‍💻</div>
    </div>
    """,
