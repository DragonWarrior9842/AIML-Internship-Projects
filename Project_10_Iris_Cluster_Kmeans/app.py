...
# Keep only petal length & width, as per the exercise
...
# Plot centroids (convert back to original scale if scaled)
...
# ---------------------------------------------------------------
# Comparison with true species (for reference / validation)
# ---------------------------------------------------------------
